...
static Cluster vibration_in_clusters[] = {
    Cluster(BASIC_CLUSTER_ID, vibration_basic_attr, sizeof(vibration_basic_attr)),
    Cluster(IAS_ZONE_CLUSTER_ID, vibration_attr, sizeof(vibration_attr))};
static Cluster light_in_clusters[] = {
    Cluster(BASIC_CLUSTER_ID, light_basic_attr, sizeof(light_basic_attr)),
    Cluster(ON_OFF_CLUSTER_ID, light_bool_attr, sizeof(light_bool_attr)),
    Cluster(LEVEL_CONTROL_CLUSTER_ID, light_level_attr, sizeof(light_level_attr)),
    Cluster(COLOR_CLUSTER_ID, light_color_attr, sizeof(light_color_attr)),
};
...
static Endpoint ENDPOINTS[NUM_ENDPOINTS] = {
    ...
    Endpoint(3, IAS_ZONE, vibration_in_clusters, out_clusters, sizeof(vibration_in_clusters), 0),
    Endpoint(4, COLOR_LIGHT, light_in_clusters, out_clusters, sizeof(light_in_clusters), 0),
};
